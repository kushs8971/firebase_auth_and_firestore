...
class _SignUpState extends State<SignUp> {
              ...
              children: [
                ...
                Align(
                  ...
                  child: Container(
                    ...
                    child: Text(
                      "Forgot Password?",
                      style: TextStyle(color: AppStyles.purpleShade),
                    ),
                  ),
                ),
                SizedBox(
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        border: Border.all(color: AppStyles.greyShade)),
                    child: Row(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        "Sign In",
                        style:
                            TextStyle(color: AppStyles.purpleShade, fontSize: 14),
                      ),
                    ],
                  ),
                )
  ...
  bool validateForm(){
    ...
    final passwordValidateString = isPasswordValid(_passwordController.text.trim());
